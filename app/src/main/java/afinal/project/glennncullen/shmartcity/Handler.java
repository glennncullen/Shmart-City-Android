...
public class Handler {
    ...
    private static void logout(){
        activityInFocus.startActivity(new Intent(activityInFocus.getApplicationContext() ,MainActivity.class));
    }
    ...
    private static void connectToMQTT(){
        ...
        CognitoCachingCredentialsProvider credentialsProvider = new CognitoCachingCredentialsProvider(
                activityInFocus.getApplicationContext(), // context
        ...
        keystorePath = activityInFocus.getApplicationContext().getFilesDir().getPath();
